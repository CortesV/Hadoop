...
public class DBOutputWritable implements Serializable, Writable, DBWritable {
	...
	public DBOutputWritable(Integer id, String uuid, Integer yearProduce, String brand, String model, String color,
			Integer price) {
		super();
		this.id = id;
		this.uuid = uuid;
