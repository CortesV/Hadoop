...
public class DBInputWritable implements Serializable, Writable, DBWritable {
	...
	public DBInputWritable(Integer id, String uuid, Integer yearProduce, String brand, String model, String color,
			Integer price) {
		this.id = id;
		this.uuid = uuid;
