...
public class HadoopDriver extends Configured implements Tool {
	...
	private static final Logger LOGGER = Logger.getLogger(HadoopDriver.class);
	...
	public Integer runJob() throws Exception{
		...
		return ToolRunner.run(new HadoopDriver(), null);
	}
	...
	public int run(String[] args) throws Exception {
		...
		DBInputFormat.setInput(job, DBInputWritable.class, "car", null, null, new String[] { "id", "brand" });
